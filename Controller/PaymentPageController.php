  ...
  private function __generateHipayWalletForm($offer) {
    $xml = "<?xml version='1.0' encoding='utf-8' ?>"
      . "<order>"
        ...
        . "<label>".$offer['credits']." ".$this->Configuration->getMoneyName()." pour {$this->User->getKey('pseudo')}</label>"
        ...
        . "<items>"
            . "<item id='1'>"
                . "<name>{$offer['credits']} {$this->Configuration->getMoneyName()} pour {$this->User->getKey('pseudo')}</name>"
